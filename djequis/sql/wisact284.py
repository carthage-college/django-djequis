def getaid(dispersed):
    ...
    WIS_ACT_284_SQL = '''
        ...
        (select distinct
            ...
            SUM(case when Aid_Record_Aid_Table.frm_code = 'PFGR' then Aid_Record.amt else 0 end) as c_FedGrants,
            SUM(case when Aid_Record_Aid_Table.frm_code = 'PSGR' then Aid_Record.amt else 0 end) as c_SteGrants,
            SUM(case when Aid_Record_Aid_Table.frm_code = 'POUT' then Aid_Record.amt else 0 end) as c_OutsideAid
        from
            aid_rec Aid_Record,
