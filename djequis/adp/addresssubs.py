...
def archive_address(id, fullname, addr1, addr2, addr3, cty, st, zp, ctry):
  # try
    ...
    if addr_result == None:  # No address in aa rec?
          ...
          insert_aa(id, fullname, addr1, addr2, addr3, cty, st, zp, ctry, max_date)
    ...
    # '15008 Lost Canyon Ct.#102', '', '', 'Woodbridge', 'VA', '22191', 'USA')
        ...
        update_aa(addr_result[0],addr_result[1],addr_result[2], fullname,
    ...
    # End old, insert new
        ...
        end_date_aa(addr_result[0],addr_result[2],fullname,addr_result[3],
                    datetime.now().strftime("%m/%d/%Y"))
        insert_aa(id, fullname, addr1, addr2, addr3, cty, st, zp, ctry, beg_date)
