...
def main():
    ...
    adirondackdata = ('{0}users.csv'.format(
    ...
    try:
        ...
        with open("adirondackdata.csv", 'w') as file_out:
        ...
        #          "eu_gdpr_subject"])
                ...
                "ADDITIONAL_ID2",
                "CLASS_STATUS", "STUDENT_STATUS",  "MAJOR", "CREDITS_SEMESTER",
                "CREDITS_CUMULATIVE", "GPA", "MOBILE_PHONE",
                "MOBILE_PHONE_CARRIER", "OPT_OUT_OF_TEXT",
                "CAMPUS_EMAIL", "PERSONAL_EMAIL", "PERM_PO_BOX",
                ...
                "ADDRESS1_PHONE", "ADDRESS2_TYPE", "ADDRESS2_STREET_LINE_1",
                ...
                "ADDRESS2_PHONE", "ADDRESS3_TYPE", "ADDRESS3_STREET_LINE_1",
                ...
                "ADDRESS3_PHONE", "CONTACT1_TYPE", "CONTACT1_NAME",
                "CONTACT1_RELATIONSHIP", "CONTACT1_HOME_PHONE",
                "CONTACT1_WORK_PHONE", "CONTACT1_MOBILE_PHONE",
                "CONTACT1_EMAIL", "CONTACT1_STREET", "CONTACT1_STREET2",
                "CONTACT1_CITY", "CONTACT1_STATE", "CONTACT1_ZIP",
                "CONTACT1_COUNTRY", "CONTACT2_TYPE", "CONTACT2_NAME",
                ...
                "CONTACT3_COUNTRY", "TERM", "RaceCode", "preferred_pronoun",
                "Service_Emotional_Support_Animal", "Greek_Affiliation"])
        file_out.close()
        ...
        if ret is None:
            ...
            with open("adirondackdata.csv", 'a') as file_out:
                csvWriter = csv.writer(file_out, delimiter='|')
